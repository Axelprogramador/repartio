...
class ThemeViewModel @Inject constructor(
    ...
    fun setDarkMode(preference: DarkModePreference) {
        viewModelScope.launch { themeManager.setDarkMode(preference) }
    }

    fun setCurrency(preference: CurrencyPreference) {
        viewModelScope.launch { currencyManager.setCurrency(preference) }
    }
